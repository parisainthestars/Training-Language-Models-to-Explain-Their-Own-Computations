...
OUTPUT_DIR = "/mnt/raid10/ak-research-01/ak-research-01/codes/steer-vector/latentqa/3_input_ablation/models/qwen"
...
def preprocess_example(example: Dict[str, Any]) -> Dict[str, Any]:
    ...
    hint_letter = example["hint_letter"]

    # Original explainer_prompt uses "Hint: D".
    # For Qwen, we want "Hint: The answer is D".
    prompt_raw: str = example["explainer_prompt"]
    qwen_hint = f"Hint: The answer is {hint_letter}"

    # Replace only the simple "Hint: <letter>" form.
    # If you want to be extra safe, you can use a regex instead.
    prompt = prompt_raw.replace(f"Hint: {hint_letter}", qwen_hint)
